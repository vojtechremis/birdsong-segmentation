...
class TDCNPPdetect(pl.LightningModule):
...
if __name__ == '__main__':
    ...
    import json
    config = json.load(open('/Users/vojtechremis/Desktop/Projects/birdsong-segmentation/MixIT_network/model/config.json'))

    model = TDCNPPArchitecture(model_config = config.get('model'))
