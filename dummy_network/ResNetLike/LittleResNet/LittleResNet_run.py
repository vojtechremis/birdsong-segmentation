...
from ResNetHandler import LittleResNet, ResNetHandler
...
if __name__ == '__main__':
    ...
    model = ResNetHandler(model=LittleResNet(input_channels=1, dropout_prob=DROPOUT), dataset=SpectrogramDataset, log_mode='wandb', log_params=log_params).to(device)
