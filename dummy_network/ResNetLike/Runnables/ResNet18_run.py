...
from ResNetHandler import ResNet18Architecture, ResNetHandler
...
if __name__ == '__main__':
    ...
    CONFIG = load_config('ResNet18_config.json')
    ...
    model = ResNetHandler(model=ResNet18Architecture(), dataset=SpectrogramDataset, log_mode='wandb', log_params=log_params).to(device)
